...
from relaxation_labeling import rl_segmentation
...
ml_probs = ml_segmentation(X, nmc_labels, return_type='probs')
ml_img = label_image_from_probabilities(ml_probs)

rl_img = rl_segmentation(ml_probs, n_iter=10, return_type='img')
