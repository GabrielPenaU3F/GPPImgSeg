...
img, ground_truth = generate_textured_image(size=(256, 256), n_regions=k, seed=seed,
                                 smoothness=[0.5, 0.1, 0.3], intensity=[0.8, 0.5, 1.1])
noisy_img = add_salt_pepper_noise(img, salt_prob=0.005, pepper_prob=0.005, seed=seed)
...
nmc_labels = NMCLabeler().label(noisy_img, n_iter=10, n_classes=k, return_type='raw')
